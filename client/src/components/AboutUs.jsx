...
const AboutUs = () => {
    return (
        <section class="bg-[#ecf1f9] py-24 relative">
            <div class="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
                <div class="w-full justify-start items-center gap-8 grid lg:grid-cols-2 grid-cols-1">
                    <div class="w-full flex-col justify-start lg:items-start items-center gap-10 inline-flex">
                        <div class="w-full flex-col justify-start lg:items-start items-center gap-4 flex">
                            <h2 class="text-gray-900 text-4xl font-bold font-manrope leading-normal lg:text-start text-center">Empowering Your Journey Through Collaboration and Personal Growth</h2>
                            <p class="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">At AI Habit Buddy, we believe in the power of habits to transform lives. Our mission is to empower individuals to build meaningful routines and achieve their goals through smart planning, personalized insights, and collaborative growth.
                    ...
                    <img class="lg:mx-0 mx-auto h-full rounded-3xl object-cover" src={AboutImg} alt="about Us image" />
                </div>
            </div>
        </section>
