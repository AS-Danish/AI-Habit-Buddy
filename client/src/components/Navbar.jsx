...
import { useUser } from '@clerk/clerk-react'; // Import useUser hook for checking user status
      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          {!isSignedIn ? (
            ...
            <UserButton className="!text-3xl" /> // Display UserButton if the user is signed in
          )}
          <button
            onClick={toggleMenu}
            type="button"
